...
class ClassBlock(nn.Module):
    def __init__(self, input_dim, class_num, droprate, relu=True, bnorm=True, linear=512, return_f=False):
...
class ft_net(nn.Module):
    ...
    def __init__(self, class_num=237, droprate=0.7, stride=2, circle=False, ibn=False, linear_num=512):
...
class ft_net_middle(nn.Module):
    ...
    def __init__(self, class_num=237, droprate=0.5):
